...
- Moved event metadata registration and the event-editor occupancy box to the required Mlýn Event plugin.
- Integrated occupancy imports and direct event edits through the Mlýn Event public API.
